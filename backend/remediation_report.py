...
class RemediationReportGenerator:
    ...
    def generate_report(self, data: RemediationReportData) -> Path:
        ...
        # Header
        story.append(Paragraph("PDFAccess Remediation Report", title_style))
...
def generate_remediation_report_for_api(
    *,
    ...
    doc = SimpleDocTemplate(
        ...
        title="PDFAccess Remediation Report",
    )
    story: List[Any] = [
        Paragraph("PDFAccess Remediation Report", title_style),
